...
public class SpectralFluxInfo2
{
	public float time;
...
public class SpectrumAnalyzer
{
	...
	int thresholdWindowSize = 398;
	public List<SpectralFluxInfo2> spectralFluxSamples;
	...
	{
		spectralFluxSamples = new List<SpectralFluxInfo2>();
	...
	public void analyzeSpectrum(float[] spectrum, float time)
	{
		...
		SpectralFluxInfo2 curInfo = new SpectralFluxInfo2();
		curInfo.time = time;
